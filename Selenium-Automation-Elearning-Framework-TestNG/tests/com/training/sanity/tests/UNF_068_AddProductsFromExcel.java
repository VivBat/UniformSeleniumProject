...
import com.training.dataproviders.UNF_068_Dataproviders;
...
public class UNF_068_AddProductsFromExcel {
	...
	@Test(dataProvider="UNFTD_007", dataProviderClass = UNF_068_Dataproviders.class)
	...
	public void addMultipleProducts(String name, String metaTag, String model, double price, String category) {
		...
		AUT_addNewProduct.assertMsgCheck();
